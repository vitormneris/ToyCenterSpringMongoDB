...
public class ClientWebController {
	...
	public String findAClient(Model model) {
		...
		ClientDTO clientDTO = service.findById(clientId);
	...
	public String insert(Model model) {
		...
		if (!administratorIsLogged()) return  "redirect:/administrator/login";
		model.addAttribute("clientDTO", new ClientDTO(null, null, null, null, null, null, null));
	...
	@PostMapping("/insert")
	public String insert(@ModelAttribute("clientDTO") ClientDTO clientDTO) {
		service.insert(clientDTO);
		return "redirect:/client/findAll";
	}
	
	@PostMapping("/insertClient")
	public String insertClient(@ModelAttribute("clientDTO") ClientDTO clientDTO) {
		service.insert(clientDTO);
		return "redirect:/client/login";
	}

    @PostMapping("/login")
    public String login(@ModelAttribute ClientDTO clientDTO, HttpSession session, HttpServletRequest request) {
        if (service.login(clientDTO)) {
            ClientDTO clientDTOFound = service.findByEmail(clientDTO.email());
            session.setAttribute("clientId", clientDTOFound.id());
	...
	public String updateByClient(@ModelAttribute("clientDTO") ClientDTO clientDTO, @PathVariable String id) {
	...
	public String update(@ModelAttribute("clientDTO") ClientDTO clientDTO, @PathVariable String id) {
    	service.update(id, clientDTO);
		return "redirect:/client/findAll";
	}
